...
class _ParamTraits:
    ...
    def checkedBulkRead(cls, var, size, fields):
        ...
        ifbad.addifstmts([
            cls.fatalError(cls.readervar, errmsg),
        ...
        for c in ud.components:
            copyswitch.addcase(
                ...
                StmtBlock([
                    StmtExpr(
                        c.callCtor(
                            ExprCall(ExprSelect(othervar, ".", c.getConstTypeName()))
                        )
                    ),
                    StmtBreak(),
                ]),
    ...
    for c in ud.components:
        ...
        if c.recursive:
            ...
            case.addstmts([
                ...
                StmtExpr(
                    c.callCtor(
                        ExprMove(ExprCall(ExprSelect(othervar, ".", c.getTypeName())))
                    )
                ),
    ...
    if not unionNeedsMove:
        ...
        for c in ud.components:
            ...
            case.addstmts([
                maybeDestroy(),
                StmtExpr(
                    c.callCtor(ExprCall(ExprSelect(rhsvar, ".", c.getConstTypeName())))
                ),
                StmtBreak(),
            ])
...
class _GenerateProtocolActorCode(ipdl.ast.Visitor):
    def __init__(self, myside):
        ...
        self.typedefSet = set([
            ...
            Typedef(Type("mozilla::ipc::ResponseRejectReason"), "ResponseRejectReason"),
        ])
                    ...
                    StmtBlock([
                        StmtExpr(
                            ExprCall(
                                ...
                                [
                                    ExprLiteral.String(
                                        self.protocol.name + "::" + md.prettyMsgName()
                                    ),
                                    ExprVar("IPC"),
                                ],
                            )
