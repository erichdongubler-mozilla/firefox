...
# fmt: off
# (stream, expected_log_level, line)
SAMPLE_LOG_BUILD_OUTPUT = [
    ...
    (STDERR, SUPPRESSED_WARNING,  r'D:/mozilla-source/firefox/first/party/path/objidl.idl(67,10): warning: non-portable path to file "objidlbase.Idl"; specified path differs in case from file name on disk [-Wnonportable-include-path]'),
    (STDERR, SUPPRESSED_WARNING,  '   67 | #include "objidlbase.idl"'),
    (STDERR, SUPPRESSED_WARNING,  "      |          ^~~~~~~~~~~~~~~~"),
    (STDERR, SUPPRESSED_WARNING,  '      |          "objidlbase.Idl"'),
    (STDERR, BUILD_ERROR,         "1 error generated."),
    (STDOUT, logging.INFO,        "./registered_field_trials.h.stub"),
    (STDERR, THIRD_PARTY_WARNING, "D:/mozilla-source/firefox/nsprpub/pr/src/misc/prdtoa.c(1261,27): warning: operator '>>' has lower precedence than '-'; '-' will be evaluated first [-Wshift-op-parentheses]"),
    ...
    (STDOUT, logging.INFO,        "   Compiling syn v2.0.106"),
    (STDERR, BUILD_ERROR,         "D:/mozilla-source/firefox/browser/app/nsBrowserApp.cpp(6,1): error: unknown type name 'syntax'"),
    ...
    (STDERR, logging.WARNING,     'D:/mozilla-source/firefox/browser/app/nsBrowserApp.cpp(6,2): warning: "test warning for build output" [-W#warnings]'),
    ...
    (STDERR, BUILD_ERROR,         "mozmake[4]: *** [D:/mozilla-source/firefox/config/rules.mk:670: nsBrowserApp.obj] Error 1"),
    (STDERR, BUILD_ERROR,         "mozmake[3]: *** [D:/mozilla-source/firefox/config/recurse.mk:72: browser/app/target-objects] Error 2"),
    ...
    (STDERR, BUILD_ERROR,         "mozmake[2]: *** [D:/mozilla-source/firefox/config/recurse.mk:34: compile] Error 2"),
    (STDERR, BUILD_ERROR,         "mozmake[1]: *** [D:/mozilla-source/firefox/config/rules.mk:359: default] Error 2"),
...
class TestBuildOutputLogLevel(unittest.TestCase):
    def test_build_output_log_levels(self):
        ...
        for stream, expected, line in SAMPLE_LOG_BUILD_OUTPUT:
