...
class DocumentOrShadowRoot {
 ...
 protected:
  ...
  /**
   * mReferenceTargetObserverMap keeps track of the callbacks which should be
   * called when an element's resolved reference target changes.
   * See AddReferenceTargetChangeObserver().
   */
