...
mod foreign {
    use wgc::{
        ...
        command::{
            AttachmentError, ClearError, ColorAttachmentError, CommandEncoderError,
            ComputePassError, CopyError, CreateRenderBundleError, EncoderStateError, QueryError,
    ...
    impl HasErrorBufferType for EncoderStateError {
        fn error_type(&self) -> ErrorBufferType {
            match self {
                EncoderStateError::Invalid => ErrorBufferType::Internal,
    ...
    impl HasErrorBufferType for CopyError {
        fn error_type(&self) -> ErrorBufferType {
            match self {
                ...
                CopyError::DestroyedResource(e) => e.error_type(),
                CopyError::InvalidResource(e) => e.error_type(),
